...
public class inspector implements EntryPoint {
	 ...
	 * service.
	 */
	private final MaurycyServiceAsync mjsService = GWT.create(MaurycyService.class);
	...
	public void onModuleLoad() {
		...
		RootPanel.get("strFieldContainer").add(nameField);
		...
		dialogBox.setText("Remote Processing Call");
		...
		dialogVPanel.add(new HTML("<b>Sending info to the server:</b>"));
